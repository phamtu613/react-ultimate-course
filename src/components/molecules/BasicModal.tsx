...
function BasicModal({ children, open, closeModal }: BasicModalProps) {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center overflow-y-auto modal z-99999">
      ...
      <div className="relative w-full rounded-3xl bg-white  dark:bg-gray-900  max-w-[700px] m-4">
        ...
        <div>
          <div className="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11 text-white">
            {children}
          </div>
        </div>
      </div>
